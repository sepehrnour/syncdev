...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center md:py-25 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-3xl font-bold mb-30 text-center"
      >
        {title || (
          <span>
